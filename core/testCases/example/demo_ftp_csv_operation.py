...
class FtpCSVOperation(TestBase):
    """Ftp-csv操作演示"""
    ...
    def setUpClass(cls):
        ...
        cls.export_ddl_file = os.path.join(cls.report_path, 'ftp-csv.yml')
        cls.table_name = 'demo_automation_001'
        cls.db = create_db_instance_with_configuration(db_name='ftp_csv',
