...
class HDFSAvroOperation(TestBase):
    """HDFS-avro操作演示"""
    ...
    def setUpClass(cls):
        ...
        # 创建数据操作实例
        cls.ddl_file = os.path.join(cls.data_path, 'DDL', 'example', 'hdfs-avro.yml')
        cls.export_ddl_file = os.path.join(cls.report_path, 'hdfs-avro.yml')
        cls.table_name = 'demo_automation_001'
        cls.db = create_db_instance_with_configuration(db_name='hdfs_avro',
    ...
    def test_003_data_operation(self):
        ...
        self.db.manual_update_data(1, ['c1', 'c2'], [2, 'text'])
