...
class GreenPlumData:
    ...
    def int2_data(precision, scale, unsigned, **kwargs):
        return random_int(-32768, 32767), GreenPlumData.DEFAULT_PLACEHOLDER

    @staticmethod
    def int4_data(precision, scale, unsigned, **kwargs):
        return random_int(-2147483648, 2147483647), GreenPlumData.DEFAULT_PLACEHOLDER

    @staticmethod
    def int8_data(precision, scale, unsigned, **kwargs):
        return random_int(-9223372036854775808, 9223372036854775807), GreenPlumData.DEFAULT_PLACEHOLDER

    @staticmethod
    def float4_data(precision, scale, unsigned, **kwargs):
        return random_decimal(5, 2, -1000, 1000, unsigned), GreenPlumData.DEFAULT_PLACEHOLDER
    ...
    def varchar_data(precision, scale, unsigned, **kwargs):
        if precision is None:
            precision = 50
        return random_str(precision), GreenPlumData.DEFAULT_PLACEHOLDER
    ...
    def json_data(precision, scale, unsigned, **kwargs):
        return random_json(), GreenPlumData.DEFAULT_PLACEHOLDER

    @staticmethod
    def xml_data(precision, scale, unsigned, **kwargs):
        return random_xml(), GreenPlumData.DEFAULT_PLACEHOLDER

    @staticmethod
    def text_data(precision, scale, unsigned, **kwargs):
        return random_str(100), GreenPlumData.DEFAULT_PLACEHOLDER
    ...
    def money_data(precision, scale, unsigned, **kwargs):
        return random_decimal(9, 2, -1000000, 1000000, unsigned), GreenPlumData.DEFAULT_PLACEHOLDER
    ...
    def bytea_data(precision, scale, unsigned, **kwargs):
        return random_bytes(20), GreenPlumData.DEFAULT_PLACEHOLDER

    @staticmethod
    def date_data(precision, scale, unsigned, **kwargs):
        return random_date(), GreenPlumData.DEFAULT_PLACEHOLDER
    ...
    def time_data(precision, scale, unsigned, **kwargs):
        ...
        return time_without_f + '.' + time_f, GreenPlumData.DEFAULT_PLACEHOLDER

    @staticmethod
    def timetz_data(precision, scale, unsigned, **kwargs):
        if precision is None or precision == 0:
            precision = 6
        return GreenPlumData.time_data(precision, scale, unsigned, **kwargs)
    ...
    def reltime_data(precision, scale, unsigned, **kwargs):
        return "@ {0} minute".format(random_int(1, 9)), GreenPlumData.DEFAULT_PLACEHOLDER
    ...
    def point_data(precision, scale, unsigned, **kwargs):
        ...
        return geom_type, GreenPlumData.DEFAULT_PLACEHOLDER
    ...
    def smgr_data(precision, scale, unsigned, **kwargs):
        return None, GreenPlumData.DEFAULT_PLACEHOLDER
    ...
    def macaddr_data(precision, scale, unsigned, **kwargs):
        return random_mac(), GreenPlumData.DEFAULT_PLACEHOLDER
    ...
    def box_data(precision, scale, unsigned, **kwargs):
        ...
        return box, GreenPlumData.DEFAULT_PLACEHOLDER
    ...
    def name_data(precision, scale, unsigned, **kwargs):
        return random_str_without_punctuation(5), GreenPlumData.DEFAULT_PLACEHOLDER
    ...
    def inet_data(precision, scale, unsigned, **kwargs):
        return random_ip(), GreenPlumData.DEFAULT_PLACEHOLDER
    ...
    def path_data(precision, scale, unsigned, **kwargs):
        ...
        return path, GreenPlumData.DEFAULT_PLACEHOLDER
    ...
    def circle_data(precision, scale, unsigned, **kwargs):
        ...
        return circle, GreenPlumData.DEFAULT_PLACEHOLDER
    ...
    def lseg_data(precision, scale, unsigned, **kwargs):
        ...
        return lseg, GreenPlumData.DEFAULT_PLACEHOLDER

    @staticmethod
    def polygon_data(precision, scale, unsigned, **kwargs):
        polygon = random_polygon()
        return "((%s,%s),(%s,%s),(%s,%s),(%s,%s),(%s,%s))" % tuple(polygon), GreenPlumData.DEFAULT_PLACEHOLDER

    @staticmethod
    def unknown_data(precision, scale, unsigned, **kwargs):
        return random_str_which_cn_nbytes(10), GreenPlumData.DEFAULT_PLACEHOLDER


class GreenPlumDB(DBDriver):
    ALIAS = 'GREENPLUM'
...
{columns}
    ...
    def __connect(self):
        print('连接GreenPlum数据库 host: {0}, port: {1}, user: {2}, passwd: {3}, db: {4}'.format(
        ...
        for _ in range(count):
            ...
            for column in table_info.columns:
                ...
                if column.name == SORTED_AND_UNIQUE_COLUMN_NAME:
                    ...
                    placeholders.append(GreenPlumData.DEFAULT_PLACEHOLDER)
                # 如果字段允许为空，则有概率插入None
                ...
                # 基于数据类型随机生成符合类型、精度、标度的数据
                    ...
                    random_value, placeholder = getattr(GreenPlumData, column.data_type + '_data')(
    ...
    def update_data(self, count_or_condition):
        ...
        for condition in conditions:
            ...
            placeholders = []
            for column in table_info.columns:
                # 字段为SORTED_AND_UNIQUE_COLUMN_NAME，自增字段，timestamp，或主键字段，将不会修改改数据
                ...
                if not column.not_null and random_int(0, 9) == 0:
                    values.append(None)
                    placeholders.append("{0}={1}".format(column.name, GreenPlumData.DEFAULT_PLACEHOLDER))
                    continue
                # 基于数据类型随机生成符合类型、精度、标度的数据
                random_value, placeholder = getattr(GreenPlumData, column.data_type + '_data')(
                    column.precision, column.scale, column.unsigned, column_type=column.column_type)
